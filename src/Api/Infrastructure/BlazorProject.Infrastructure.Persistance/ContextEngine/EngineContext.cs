...
namespace BlazorProject.Infrastructure.Persistance.ContextEngine;
...
public class EngineContext
{
    ...
    public static IEngine Create()
    {
        ...
        return Singleton<IEngine>.Instance ?? (Singleton<IEngine>.Instance = new BlazorSocialContextEngine());
    }
